                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    speedSegment={0.3}
                                    as="h1"
                                    className="mx-auto mt-8 max-w-4xl text-balance tracking-tight text-5xl max-md:font-bold md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                                ...
                                <TextEffect
                                    ...
                                    The right technology doesn't complicate your business. It helps it flow.
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        <Link href="/contact">
                                            <span className="text-nowrap"><ERPRequestModal 
